...
export type HistoryAction =
  | { type: "edit"; value: Composition }
  | { type: "restore"; value: Composition }
  | { type: "begin" | "end" | "undo" | "redo" };
export function createHistory(present: Composition): History {
...
export function reduceHistory(s: History, a: HistoryAction): History {
  ...
  if (a.type === "end")
    return !s.transaction
      ...
      : {
          ...s,
          past: s.transaction === s.present ? s.past : [...s.past, s.transaction].slice(-60),
          transaction: null,
        };
  if (a.type === "edit")
    return a.value === s.present
      ? s
      : {
          ...s,
          past: s.transaction ? s.past : [...s.past, s.present].slice(-60),
          present: a.value,
          future: [],
        };
  ...
  if (a.type === "redo" && s.future.length)
    return {
      past: [...s.past, s.present].slice(-60),
      present: s.future[0],
